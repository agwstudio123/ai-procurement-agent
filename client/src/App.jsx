...
function Settings() {
  ...
  async function saveWallet() {
    ...
    try {
      ...
      const response = await fetch(
        `http://localhost:3000/contractors/${contractor.id}/wallet`,
        {
          method: "PUT",
          headers: {
    ...
    <div className="p-10">
      ...
      <div className="bg-white rounded-xl shadow p-8 mt-8 max-w-3xl">
        ...
        <p className="text-gray-500 mb-5">
          ...
          Your wallet is used for USDC payments
  ...
  <p className="text-gray-500 text-sm mt-3">
    This wallet will receive and send USDC payments during procurement.
  </p>

...
export default function SupplierAddMaterial() {
  ...
  async function handleSubmit(e) {
    ...
    if (id) {
      const index = updatedSupplier.materials.findIndex(
        (item) => Number(item.id) === Number(id)
      );

      updatedSupplier.materials[index] = {
        ...updatedSupplier.materials[index],
        ...material,
      };
    } else {
  ...
  return (
    <div className="min-h-screen bg-gray-100 p-4 md:p-10">
      <div className="max-w-2xl mx-auto bg-white rounded-xl shadow p-5 md:p-8">
        ...
        <p className="text-gray-600 mt-2">
          {id
            ? "Update your construction material."
